...
pacstrap -K /mnt amd-ucode base base-devel plasma-meta konsole dolphin curl git linux linux-firmware mesa openssl openssh sudo vi xorg-server-xwayland vivaldi vulkan-radeon vulkan-tools
